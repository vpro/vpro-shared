...
(function() {
    ...
    a.main = b(function(g, m, f, l, k) {
        ...
        function e(v, u) {
            ...
            r += "</div>\n    ";
            s = f["if"].call(v, ((t = v.info), t == null || t === false ? t : t.termsOfServiceUrl), {hash : {}, inverse : p.noop, fn : p.program(2, d, u), data : u});
            if(s || s === 0) {
                r += s
            }
            r += "\n    ";
            s = f["if"].call(v, ((t = v.info), t == null || t === false ? t : t.contact), {hash : {}, inverse : p.noop, fn : p.program(4, q, u), data : u});
            if(s || s === 0) {
                r += s
            }
            r += "\n    ";
            s = f["if"].call(v, ((t = v.info), t == null || t === false ? t : t.license), {hash : {}, inverse : p.noop, fn : p.program(6, o, u), data : u});
            if(s || s === 0) {
                r += s
            }
            r += "\n  ";
...
(function() {
    ...
    a.param_list = b(function(g, r, p, l, w) {
        ...
        q += "\n    ";
        e = p.each.call(r, ((i = r.allowableValues), i == null || i === false ? i : i.descriptiveValues), {hash : {}, inverse : o.noop, fn : o.program(13, u, w), data : w});
        if(e || e === 0) {
            q += e
        }
        q += "\n  </select>\n</td>\n<td>";
...
(function() {
    ...
    r = (function(z) {
        ...
        y.prototype.events = {"click #show-pet-store-icon" : "showPetStore", "click #show-wordnik-dev-icon" : "showWordnikDev", "click #explore" : "showCustom", "keyup #input_baseUrl" : "showCustomOnKeyup", "keyup #input_apiKey" : "showCustomOnKeyup"};
    ...
    o = (function(z) {
        ...
        y.prototype.events = {"submit .sandbox" : "submitOperation", "click .submit" : "submitOperation", "click .response_hider" : "hideResponse", "click .toggleOperation" : "toggleOperationContent"};
        y.prototype.initialize = function() {
        };
        y.prototype.render = function() {
        ...
        y.prototype.submitOperation = function(N) {
            var P, G, D, I, A, J, M, L, K, O, F, C, H, E, B;
            if(N != null) {
                N.preventDefault()
            }
            G = $(".sandbox", $(this.el));
        ...
        y.prototype.formatXml = function(H) {
            ...
            B = 0;
            I = "other";
            L = {"single->single" : 0, "single->closing" : -1, "single->opening" : 0, "single->other" : 0, "closing->single" : 0, "closing->closing" : -1, "closing->opening" : 0, "closing->other" : 0, "opening->single" : 1, "opening->closing" : 0, "opening->opening" : 1, "opening->other" : 1, "other->single" : 0, "other->closing" : -1, "other->opening" : 0, "other->other" : 0};
            F = function(T) {
                var P, O, R, V, S, Q, U;
                Q = {single : Boolean(T.match(/<.+\/>/)), closing : Boolean(T.match(/<\/.+>/)), opening : Boolean(T.match(/<[^!?].*>/))};
                S = ((function() {
                    var W;
                    W = [];
                    for(R in Q) {
        ...
        y.prototype.showStatus = function(D) {
            ...
            A = E;
            $(".request_url").html("<pre>" + D.request.url + "</pre>");
            $(".response_code", $(this.el)).html("<pre>" + D.status + "</pre>");
            $(".response_body", $(this.el)).html(A);
            $(".response_headers", $(this.el)).html("<pre>" + JSON.stringify(D.getHeaders()) + "</pre>");
    ...
    i = (function(z) {
        ...
        y.prototype.events = {"click a.description-link" : "switchToDescription", "click a.snippet-link" : "switchToSnippet", "mousedown .snippet" : "snippetToTextArea"};
        y.prototype.initialize = function() {
        };
        y.prototype.render = function() {
            var A;
