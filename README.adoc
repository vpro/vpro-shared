...
image:http://www.javadoc.io/badge/nl.vpro.shared/vpro-shared-util.svg?color=blue[javadoc,link=http://www.javadoc.io/doc/nl.vpro.shared]
...
* link:vpro-shared-swagger3[vpro-shared-swagger3], link:vpro-shared-swagger3-taglib[vpro-shared-swagger3-tglib]: Some utilities related to swagger frontend and openapi. Depends on webjars to provide the actual swagger frontend too
...
* link:vpro-shared-test[vpro-shared-test]: Utilities related to testing. junit5 plugins, assertj assertions
...
| 5.14
| Support for Jackson3
| January 2026


| 6.x >
| java 21 (released in sep. 2023), spring 7, hibernate 7
| 2026?
